            ...
            <div className={todayStyles["create__new__task"]}> 
                ...
                <div className={form ? todayStyles["create__task__form"] : todayStyles["create__task__form--active"]}> 
                    <form>
                        ...
                        <input value={formName} onChange={e => setFormName(e.target.value)} className={todayStyles["create__task__form--input"]} placeholder="Люблю сырники" type="text" /><br /> 
                        <label className={todayStyles["create__task__form--label"]} htmlFor="">Текст</label><br /> 
                        <textarea value={text} onChange={e => setText(e.target.value)} className={todayStyles["create__task__form--textarea"]} placeholder="Бенедикт" type="text" /><br /> 
